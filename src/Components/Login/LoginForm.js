  ...
  return (
    <div className="LoginForm">
       <div className="login-box">
        <input type="text" placeholder="ID" className="login-input" value={id}
        onChange={(e) => setId(e.target.value)} />
        <input type="password" placeholder="Password" className="login-input"  value={password}
        ...
        <div className="find-info">
          ...
          <div className="singup">
            <Link to="/signup" className="find-link">회원가입하기</Link>
          </div>
          
         </div>
         <Link to="/Main">
         <button className="login-btn" onClick={handleLogin}>로그인하기</button></Link>
    </div>
    </div>
  );
};
